...
```
invalid declaration:
  tool broken · bad: CM1001: ParseError: 'not.a.keyword' is unresolvable (fix: Use a resolvable ArkType definition.)
  tool broken: CM1006: flag --same is claimed by flag and other (fix: Rename one of the flags or aliases.)
```
